<?php
/**
 * סקריפט להוספת 50 צמתים חדשים לקובץ JSON הקיים
 */
...
if ($existingNodes === null) {
    die("Error: Could not parse existing JSON file\n");
}

echo "Found " . count($existingNodes) . " existing nodes\n";
