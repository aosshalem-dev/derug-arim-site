...
CLUSTERS = {
    "dror_israel": {
        ...
        "summary": "רשת של 14+ קיבוצים עירוניים, שליטה מרוכזת בידי פסח האוספטר. תקציב שנתי 230 מיליון ₪. חינוך ביקורתי, תוכנית 'לגעת בזה' לחינוך מגדרי-מיני. פרשת בני המושבים (פער של 30 מיליון ₪). קשרים עמוקים לשמאל הפוליטי.",
        "key_findings": [
    ...
    "political_activist": {
        ...
        "summary": "ארגונים עם אג'נדה פוליטית מובהקת הפועלים בחינוך. האגודה לזכויות האזרח בדירוג 5/5 — אקטיביזם שמאלי מפורש. מרכז רוסינג 4/5 — נטייה פוסט-לאומית. מימון זר מסיבי (45+ מיליון אירו ממקורות אירופאיים ואמריקאיים).",
        "key_findings": [
    ...
    "hartman": {
        ...
        "summary": "מכון אקדמי-רעיוני עם פדגוגיה ליברלית-ביקורתית. ריכוז סמכויות בידי הרב דניאל הרטמן (28 שנה). מימון כמעט מוחלט מתורמים זרים (10.5+ מיליון דולר/שנה מצפון אמריקה). פמיניזם ביהדות.",
        "key_findings": [
            "ריכוז סמכויות: הרב דניאל הרטמן — נשיא 28 שנים",
            "פדגוגיה ליברלית-ביקורתית — לא אנטי-מדינתי אך מאתגר מבנים",
    ...
    "foreign_coexistence": {
        ...
        "summary": "ארגונים במימון זר כבד הפועלים בחינוך תחת כסות דו-קיום ופלורליזם. פרויקט מרחבים (ידידות טורונטו) — 800 מיליון ₪ ממימון קנדי. מסע לקשר — סוס טרויאני לאידיאולוגיה ליברלית בקהילות חרדיות.",
        "key_findings": [
            "פרויקט מרחבים: 800 מיליון ₪ מימון היסטורי מקרן פרידברג (קנדה)",
            "מיקוד בנערות חרדיות — סוס טרויאני לאידיאולוגיה ליברלית",
    ...
    "feminist": {
        ...
        "key_findings": [
            ...
            "רשת פועלת דרך ג'וינט ישראל (השקפת עולם ליברלית)",
        ],
    },
    "child_protection": {
